...
#SBATCH --output=compute_features_pascal.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=compute_features_pascal.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
