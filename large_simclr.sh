...
#SBATCH --output=large_simclr.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=large_simclr.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
