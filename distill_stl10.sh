...
#SBATCH --output=d_stl10.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=d_stl10.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
