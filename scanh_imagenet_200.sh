...
#SBATCH --output=scnh_i200.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=scnh_i200.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
