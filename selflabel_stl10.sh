...
#SBATCH --output=slbl_stl10.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=slbl_stl10.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
