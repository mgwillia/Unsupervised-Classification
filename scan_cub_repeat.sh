...
#SBATCH --output=scan_cub_repeat.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=scan_cub_repeat.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
