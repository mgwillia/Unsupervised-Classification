...
#SBATCH --output=pascal_224_scan_200.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=pascal_224_scan_200.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
