...
#SBATCH --output=sclr_i50-0.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=sclr_i50-0.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
