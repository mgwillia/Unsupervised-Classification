...
#SBATCH --output=scnc_i200.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=scnc_i200.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
