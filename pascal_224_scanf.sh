...
#SBATCH --output=pascal_224_scanf.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=pascal_224_scanf.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
