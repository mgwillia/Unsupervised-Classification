...
#SBATCH --output=f_i50.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=f_i50.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
