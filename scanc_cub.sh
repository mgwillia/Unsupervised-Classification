...
#SBATCH --output=scanc_cub.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=scanc_cub.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
