...
#SBATCH --output=simclr_imagenet.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=simclr_imagenet.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
