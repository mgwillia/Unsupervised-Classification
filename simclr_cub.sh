...
#SBATCH --output=simclr_cub_256.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=simclr_cub_256.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
