...
class VOCSegmentation(VisionDataset):
    ...
    def __init__(
        ...
        #NOTE: I had to switch transform and transforms here. Could cause confusion later on
        super(VOCSegmentation, self).__init__(root, transform, transforms, target_transform)
        self.year = year
