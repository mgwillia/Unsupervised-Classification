...
#SBATCH --output=selflabel_cub.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=selflabel_cub.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
