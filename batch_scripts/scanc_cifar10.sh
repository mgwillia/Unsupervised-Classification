...
#SBATCH --output=outfiles/scanc_cifar10.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/scanc_cifar10.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
