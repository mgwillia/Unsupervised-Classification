...
#SBATCH --output=outfiles/linearprobe_imagenet_50_finetune.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/linearprobe_imagenet_50_finetune.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
