...
#SBATCH --output=outfiles/scan_cifar10_repeat.out.%j                     # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/scan_cifar10_repeat.out.%j                      # indicates a file to redirect STDERR to; %j is the jobid
