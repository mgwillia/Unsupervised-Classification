...
#SBATCH --job-name=d_stl10                                # sets the job name
#SBATCH --output=outfiles/d_stl10.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/d_stl10.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
