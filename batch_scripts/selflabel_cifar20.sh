...
#SBATCH --output=outfiles/slbl_c20.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/slbl_c20.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
