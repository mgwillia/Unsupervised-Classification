...
srun bash -c "hostname; CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python simclr-distill.py --config_env configs/env.yml --config_exp configs/pretext/distill_imagenet_50_2.yml --mode train"
