...
#SBATCH --output=outfiles/sclr_stl10.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/sclr_stl10.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
