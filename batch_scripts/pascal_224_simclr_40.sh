...
#SBATCH --output=outfiles/pascal_224_simclr_40.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/pascal_224_simclr_40.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
