...
#SBATCH --output=outfiles/scnk_c10.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/scnk_c10.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
