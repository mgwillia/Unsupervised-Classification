...
#SBATCH --output=outfiles/eval_imagenet_50.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/eval_imagenet_50.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
