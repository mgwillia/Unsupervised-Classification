...
srun bash -c "hostname; CUDA_VISIBLE_DEVICES=0,1 python simclr-distill.py --config_env configs/env.yml --config_exp configs/pretext/distill_cifar20.yml --mode train"
