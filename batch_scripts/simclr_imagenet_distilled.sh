...
#SBATCH --output=outfiles/simclr_imagenet_distilled.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/simclr_imagenet_distilled.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
