...
#SBATCH --output=outfiles/linearprobe_cifar10_finetune.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/linearprobe_cifar10_finetune.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
